...
const REMEMBER_ME_KEY = "embar_remember_me";
const SESSION_ACTIVE_KEY = "embar_session_active";
...
export function LoginForm() {
  ...
  useEffect(() => {
    ...
    if (urlError === "missing_code") setError("Invalid sign-in link. Please try again.");
  }, [urlError]);
  ...
  async function handleEmailSignIn(e: React.FormEvent) {
    ...
    // Remember me: store preference so SessionGuard can enforce it
    if (rememberMe) {
      ...
      <form onSubmit={handleEmailSignIn} className="space-y-4">
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            disabled={loading}
          />
          <label htmlFor="remember-me" className="select-none text-sm text-muted-foreground">
            Remember me
          </label>
        </div>
